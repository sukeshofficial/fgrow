                                ...
                                {showRevMenu && (
                                    <div className="chart-dropdown-menu">
                                        <div className="menu-section">
                                            ...
                                            <button
                                                className={`menu-item ${revViewMode === "composed" ? "active" : ""}`}
                                                onClick={() => setRevViewMode("composed")}
                                            >
                                                Composed View
                                            </button>
                                            <button
                                                className={`menu-item ${revViewMode === "histogram" ? "active" : ""}`}
                                                onClick={() => setRevViewMode("histogram")}
                                            >
                                                Histogram Only
                                            </button>
                                            <button
                                                className={`menu-item ${revViewMode === "line" ? "active" : ""}`}
                                        ...
                                        <div className="menu-section">
                                            <span className="menu-label">Time Period</span>
                                            <button
                                                className={`menu-item ${revTimeRange === "3m" ? "active" : ""}`}
                                                onClick={() => setRevTimeRange("3m")}
                                            >
                                                Last 3 Months
                                            </button>
                                            <button
                                                className={`menu-item ${revTimeRange === "6m" ? "active" : ""}`}
                                                onClick={() => setRevTimeRange("6m")}
                                            >
                                                Last 6 Months
                                            </button>
                                            <button
                                                className={`menu-item ${revTimeRange === "all" ? "active" : ""}`}
