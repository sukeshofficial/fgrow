...
const QuotationAdvancedFilterModal = ({ isOpen, onClose, filters, onApply, onClear }) => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const clientResp = await listClients({ limit: 100 });
...
export default QuotationAdvancedFilterModal;
